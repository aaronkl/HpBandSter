...
from hpbandster.optimizers.config_generators.vrnn import VRNNWrapper as CG_VRNN

class VRNN(Master):
	def __init__(self, configspace = None,
					eta=3, min_budget=0.01, max_budget=1,
					num_samples = 64, path = './model_vrnn',
					**kwargs ):
		"""
		...
		cg = CG_VRNN( configspace = configspace,
					num_samples = num_samples, path=path
					)
