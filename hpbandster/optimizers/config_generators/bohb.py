...
class BOHB(base_config_generator):
    def __init__(self, configspace, min_points_in_model=None,
                 ...
                 bandwidth_factor=3, min_bandwidth=1e-3, optimization_strategy="sampling",
                 **kwargs):
        """
    ...
    def get_config(self, budget):
        ...
        if self.optimization_strategy == "sampling":
            best = np.inf
            best_vector = None
        ...
        elif self.optimization_strategy == "local_search":
            try:
                ...
                acquisition = lambda x: -(max(1e-32, g(x)) / max(l(x), 1e-32))
